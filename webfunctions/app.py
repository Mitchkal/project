...
from flask import Flask, jsonify, Response, render_template, make_response, request, redirect, url_for
...
def retrive_products_from_store():
    ...
    serialized_products = jsonify(products)
...
if __name__ == "__main__":
    ...
    The main function
    """
    host = environ.get('HAVEN_HOST', '0.0.0.0')
    port = int(environ.get('HAVEN_API_PORT', 5000))
